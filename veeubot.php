...
//intro
echo "$kuning >> tunggu sebentar bro ...\n";
sleep(1);
...
echo "$ijo [-]  sukses !!!\n";
echo "$kuning Nama  : $biru".$jres['user']['nickname']."\n";
echo "$kuning Email : $biru".$jres['user']['email']."\n";
break;
endwhile;

//konfirmasi
$konfir =readline("$turkis konfirmasi (y/n): ");
       if($konfir == 'y' OR $konfir == 'Y'){
        @system("clear");
        }
        else{
        echo "$red [!] ".$red."Login Gagal !1!1\n";
        exit;
        }

//intro2

echo "$kuning >> $putih memproses data !1!1\n";
sleep(1);
echo "$kuning >> $putih memproses bot ...\n";
sleep(1);
//include
include('modules');
...
echo "$kuning >> $ijo sukses $kuning Nama: $biru".$jres['user']['nickname']."$ijo
